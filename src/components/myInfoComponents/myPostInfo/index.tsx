...
import HourlypayCalc from '@/components/commonComponents/hourlypayCalc';
      ...
      <div className="flex p-[12px] md:p-[16px] flex-col items-start gap-[12px] md:gap-[20px] rounded-[12px] border border-gray20">
        ...
        <div className="flex flex-col items-start gap-[16px] self-stretch">
          <div className="flex flex-col items-start gap-[8px] self-stretch">
            ...
            <div className="flex items-start gap-[6px] self-stretch">
              ...
              <div className="flex flex-col md:flex-row md:gap-[7px]">
                ...
                >
                  {formatWorkSchedule(noticeData?.startsAt, noticeData?.workhour)}
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-1 md:gap-0 md:flex-row md:justify-between items-start self-stretch">
            ...
            >
              {formatCurrency(noticeData?.hourlyPay)}원
            </span>
            <HourlypayCalc
              originalPay={cachedShopData?.item.originalHourlyPay}
              currentPay={noticeData?.hourlyPay}
              deadline={noticeData?.closed}
            />
          </div>
        </div>
      </div>
